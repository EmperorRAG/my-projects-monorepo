...
export {
  runTableTestWithMatcher,
  runExpectToBeTableTest,
} from './lib/helper-functions/runTableTest.utils';
export {
...
export {
  ...
  isUndefined,
  isPrimitive,
} from './lib/types/primitive.types';
export {
  isArray,
  isDate,
  isRegExp,
  ...
  throwsOnToString,
  isPlainObject,
} from './lib/types/object.types';
export {
  isArrowFunction,
  isNamedFunction,
  isFunction,
} from './lib/types/function.types';
export type {
  Stringable,
  PrimitiveStringable,
} from './lib/types/stringable/stringable.types';
export {
  isValueStringable,
  isValuePrimitiveStringable,
} from './lib/types/stringable/stringable.types';
export {
  isValueArrayOfStrings,
  isValueArrayOfUnknowns,
  isValueArrayOf,
  isValueArrayOfStringable,
} from './lib/types/array/array.types';
...
export {
  isValueRecordOfUnknown,
  isValueRecordOf,
} from './lib/types/record/record.types';
